                ...
                {!id ? 
                    ...
                    ( 
                        ...
                        >     
                            ...
                            <Box sx={{height: {xs: '80%', sm: '20%'}, overflow: {xs: 'auto', sm: 'hidden'}}}>
                            ...
                            <Box sx={{height:  {xs: '20%', sm: '10%'}, /* backgroundColor  : {xs: 'red', sm: 'blue'},  */borderTop: '1px solid rgba(0, 0, 0, 0.2)', display: 'flex', position: 'relative'}}>
                                <Input 
